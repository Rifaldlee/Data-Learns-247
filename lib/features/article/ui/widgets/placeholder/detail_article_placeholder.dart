...
class DetailArticlePlaceholder extends StatelessWidget {
  const DetailArticlePlaceholder({super.key});
      ...
      body: const Padding(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 8),
            RectangleShimmerSizedBox(height: 62, width: double.infinity),
            SizedBox(height: 12),
            Row(
              children: [

  ...
  Widget build(BuildContext context) {
    ...
    Widget toSignInText() {
      return Text.rich(TextSpan(
        style: Theme.of(context).textTheme.bodyLarge?.copyWith(color: kLightGreyColor),
        children: [
          const TextSpan(text: "Have an account? "),
          TextSpan(
            text: "Sign in",
            style: Theme.of(context).textTheme.bodyLarge?.copyWith(color: kGreenColor),
                          ...
                          child: Column(
                            children: [
                              ...
                              CustomFormField(
                                ...
                                hintText: "Perusahaan, universitas atau organisasi lain",
                              ...
                              CustomFormField(
                                isRequired: true,
                                fieldName: "Kota",
                                hintText: "Kota dimana anda tinggal",
                                controller: _cityController,
                                margin: const EdgeInsets.only(bottom: 20)
                              ),
                              CustomFormField(
                                isRequired: true,
                                fieldName: "Tahun lahir",
                                hintText: "Tahun anda lahir",
                              ...
                              CustomFormField(
                                isRequired: true,
                                fieldName: "Ulangi password",
                                hintText: "Ulangi password yang telah anda masukkan",
                                      ...
                                      if (_formKey.currentState!.validate()) {
                                        context.read<RegisterCubit>().register(
                                          RegisterRequestPayload(
                                            ...
                                            organization: _organizationController.value.text,
                                            yearOfBirth: _yobController.value.text
                                          )
                                        );
                                      }
                                    }
